...
-- 					-- Silence img-clip's warn/error notifications — in particular the
-- 					-- "Content is not an image." warning it fires on every plain-text
-- 					-- paste (paste.lua). Trade-off: genuine paste failures also go quiet.
-- 					verbose = false,
-- 					drag_and_drop = {
-- 						insert_mode = true,
-- 					},
